...
<div class="col-md-6"><div class="icons">
  ...
  <!-------------------------------- table data----------------------------->
 <div class="container">
<h1 class="table-heading">Dataset summary</h1>
<div class="bs-example">
    <table class="table">
        ...
        <tbody>
        	 <c:forEach var="mylist" items="${model.data}">
<tr>

<td align="center"><a href="${mylist.url}?getDataSet=${mylist.dataset_name}">${mylist.dataset_name}</a></td>
<td>${mylist.analytics_model}</td>
<td>${mylist.description}</td>
<td>${mylist.domain}</td>
<td align="center"><a href="summary.html?getschema=${mylist.schema}">Summary</a></td> 

<!-- <td align="center"><a href="${mylist.url}?getDataSet=${mylist.dataset_name}">Summary</a></td>   -->
